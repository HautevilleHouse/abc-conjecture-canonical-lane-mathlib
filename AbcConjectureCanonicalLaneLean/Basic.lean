/-!
# abc-conjecture-canonical-lane Lean migration boundary
...
`AbcConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "abc-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/abc-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the abc Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["abc-conjecture", "arithmetic-geometry", "heights", "mathematical-proof", "number-theory", "reproducibility", "diophantine-geometry", "canonical-lane", "local-to-global", "manifold-constrained"]
