# Abc Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/abc-conjecture-canonical-lane-mathlib.git
cd abc-conjecture-canonical-lane-mathlib
lake exe
lake build
```
